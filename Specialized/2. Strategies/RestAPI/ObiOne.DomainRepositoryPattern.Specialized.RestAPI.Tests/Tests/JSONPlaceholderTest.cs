...
using ObiOne.DomainRepositoryPattern.Specialized.RestAPI.Tests.DataContext;
using ObiOne.DomainRepositoryPattern.Specialized.RestAPI.Tests.Model;

namespace ObiOne.DomainRepositoryPattern.Specialized.RestAPI.Tests.Tests
{
    [TestClass]
    public class JSONPlaceholderTest
    {
        ...
        {
            try{
                using (var lAPIContext = new TestAPIContext(new TestAPIConnectionList().TestAPIConnection))
                {
                    //ARRANGE
                    var lAPIRepo = lAPIContext.GetRepository<Posts, int>();
                    ...
                    var lInitialRecordsCount = lAPIRepo.Select().Count();
